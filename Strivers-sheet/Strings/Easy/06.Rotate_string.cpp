...
3. To check for all rotations, we iterate through the length of the string, and initialise a new string which stores the concatenation of the substring from i to the end of s, and substring from 0, and of length i.
